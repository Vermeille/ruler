...
export const MAPXEL_FIELDS = {
  ...
  healthCapacity: { min: 0, delta: true },
  educationCapacity: { min: 0, delta: true },
  healthDisruption: { min: 0, max: 1, delta: true },
  educationDisruption: { min: 0, max: 1, delta: true },
  infrastructureDisruption: { min: 0, max: 1, delta: true },
  unrest: { min: 0, max: 1, delta: true },
  infection: { min: 0, max: 1, delta: true },
  policyAdjustment: { min: 0, max: 1, delta: true },
  policyTaxBaseline: { min: 0, max: 1, delta: true },
  policySpendingBaseline: { min: 0, max: 1, delta: true },
  policyWageBaseline: { min: 0, max: 1, delta: true },
  policyRightsBaseline: { min: 0, max: 1, delta: true },
  policySubsidyBaseline: { min: 0, max: 1, delta: true },
